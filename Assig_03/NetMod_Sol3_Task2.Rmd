...
plot(gof1.od)
```
All out-degrees from 0 to 8 are in the 95% confidence interval. Furthermore, the p-value is greater than 0.05 which indicates a good fit.
