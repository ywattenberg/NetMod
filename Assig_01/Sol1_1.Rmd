...
## 5)
### 5.1)
The hypothesis of the first test is testing whether there is more reciprocity then density would suggest. The test is conditioned on the edges that means on the network density or number of edges in the network or $U|p$ where p denotes the network density. 
